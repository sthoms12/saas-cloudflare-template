<script>
  ...
  const features = [
    {
      name: "Timeline",
      description: "Chronological log of all session activity, steps, and notes.",
      link: "/dashboard/tracestack/session",
      link_text: "Try Timeline",
      svg_content: `<path d='M12 2v20M2 12h20' stroke='#1C274C' stroke-width='1.5'/>`,
    },
    {
      name: "Kanban",
      description: "Visualize and manage session steps by status (To Try, In Progress, Done, Blocked).",
      link: "/dashboard/tracestack/session?tab=kanban",
      link_text: "Try Kanban",
      svg_content: `<rect x='3' y='5' width='4' height='14' stroke='#1C274C' stroke-width='1.5'/><rect x='9' y='5' width='4' height='14' stroke='#1C274C' stroke-width='1.5'/><rect x='15' y='5' width='6' height='14' stroke='#1C274C' stroke-width='1.5'/>`,
    },
    {
      name: "RawNotes",
      description: "Quick, unstructured notes for capturing ideas and observations.",
      link: "/dashboard/tracestack/session?tab=rawnotes",
      link_text: "Try RawNotes",
      svg_content: `<path d='M4 4h16v16H4z' stroke='#1C274C' stroke-width='1.5'/><path d='M8 8h8M8 12h8M8 16h4' stroke='#1C274C' stroke-width='1.5'/>`,
    },
    {
      name: "Brainstorm",
      description: "Generate and collect ideas related to the session.",
      link: "/dashboard/tracestack/session?tab=brainstorm",
      link_text: "Try Brainstorm",
      svg_content: `<circle cx='12' cy='12' r='8' stroke='#1C274C' stroke-width='1.5'/><path d='M12 8v4l3 3' stroke='#1C274C' stroke-width='1.5'/>`,
    },
    {
      name: "HypothesisTracker",
      description: "Track, rate, and manage hypotheses for the session.",
      link: "/dashboard/tracestack/session?tab=hypothesis",
      link_text: "Try HypothesisTracker",
      svg_content: `<ellipse cx='12' cy='12' rx='8' ry='5' stroke='#1C274C' stroke-width='1.5'/><path d='M12 7v5l3 3' stroke='#1C274C' stroke-width='1.5'/>`,
    },
    {
      name: "UnifiedView",
      description: "Unified dashboard showing Timeline, Brainstorm, and Hypotheses in one place.",
      link: "/dashboard/tracestack/session?tab=unified",
      link_text: "Try UnifiedView",
      svg_content: `<rect x='4' y='4' width='16' height='16' stroke='#1C274C' stroke-width='1.5'/><path d='M4 12h16M12 4v16' stroke='#1C274C' stroke-width='1.5'/>`,
    },
